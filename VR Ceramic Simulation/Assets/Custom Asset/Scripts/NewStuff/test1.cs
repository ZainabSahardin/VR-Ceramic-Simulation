...
public class test1 : MonoBehaviour
{
    ...
    public float deformationRadius = 0.01f;
    ...
    void DeformMesh()
    {
        ...
        for (int i = 0; i < originalVertices.Length; i++)
        {
            ...
            if (distanceToLeftHand <= deformationRadius)
            {
                ...
                meshVerticies[i] += transform.InverseTransformDirection(leftPosition);
            }
            ...
            if (distanceToRightHand <= deformationRadius)
            {
                ...
                meshVerticies[i] += transform.InverseTransformDirection(rightPosition);
            }
        }
